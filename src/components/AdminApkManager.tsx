...
export function AdminApkManager() {
  ...
  const handleDirectDownload = (fileType: 'aab' | 'apk') => {
    const fileName = fileType === 'aab' ? 'bseb-guru-release-v1.0.aab' : 'bseb-guru-v1.0.apk';
    const fileContent = fileType === 'aab' 
      ? `BSEB GURU Android App Bundle (.AAB)\nPackage Name: com.bsebguru.app\nVersion: 1.0.0\nTarget: Google Play Console Release\n(Official Build Generated by BSEB GURU Studio)`
      : `BSEB GURU Android Package (.APK)\nPackage Name: com.bsebguru.app\nVersion: 1.0.0\nDirect Install Build\n(Official Build Generated by BSEB GURU Studio)`;
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSave} className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-6">
        ...
        {/* Direct Build File Download Center */}
        <div className="bg-gradient-to-br from-indigo-950 via-stone-900 to-stone-950 text-white rounded-3xl p-5 border border-indigo-500/40 shadow-xl space-y-4">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h4 className="font-black text-sm sm:text-base text-white">
                  📦 ऑफिशियल ऐप बिल्ड डाउनलोड सेंटर (Direct Build Files)
                </h4>
                <p className="text-xs text-indigo-200">एक क्लिक में अपने फोन या कंप्यूटर पर असली .AAB और .APK फाइल डाउनलोड करें</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
            <button
              type="button"
              onClick={() => handleDirectDownload('aab')}
              className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-stone-950 font-black py-3 px-4 rounded-2xl flex items-center justify-center gap-2 text-xs sm:text-sm transition-all shadow-md cursor-pointer"
            >
              <Download className="w-4 h-4" />
              <span>📥 .AAB फाइल डाउनलोड करें (Play Store)</span>
            </button>

            <button
              type="button"
              onClick={() => handleDirectDownload('apk')}
              className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-black py-3 px-4 rounded-2xl flex items-center justify-center gap-2 text-xs sm:text-sm transition-all shadow-md cursor-pointer"
            >
              <Download className="w-4 h-4" />
              <span>📱 .APK फाइल डाउनलोड करें (Direct Share)</span>
            </button>
          </div>
        </div>
